...
<div class="doctorsList">
    <?foreach($arResult["ITEMS"] as $key => $arItem):?>
        ...
        ?>
        <div class="doctorsList__item"><a class="doctorsList__link" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                <?
                ...
                ?>
                <img class="doctorsList__photo" src="<?=$arItem["PREVIEW_PICTURE"]["RESIZE_IMAGE_SRC"]?>">
                <div class="doctorsList__title"><?=$arItem["NAME"]?></div>
                <div class="doctorsList__position"><?=$arItem["PROPERTIES"]["PROFESSION"]["VALUE"]?></div></a>
        </div>
    <?endforeach;?>
</div>
