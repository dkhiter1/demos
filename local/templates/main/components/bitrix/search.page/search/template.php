...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
        ...
        <div class="reviewsList__item clearfix">
            <div class="reviewsList__title"><a class="font_href" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a></div>
            <div class="reviewsList__text"><p><?echo $arItem["BODY_FORMATED"]?></p></div>
        </div>
